...
CHIP call sets are generated upstream with the Mutect2[https://dockstore.org/workflows/github.com/broadinstitute/gatk/mutect2:4.1.8.1] + ANNOVAR (Workflow Description Language) pipeline of
